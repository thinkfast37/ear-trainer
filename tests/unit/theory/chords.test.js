...
import { chordTones, qualityLabel, QUALITY_IDS, chordSize } from '../../../src/theory/chords.js';
...
describe('chords', () => {
  ...
  it('eleven qualities', () => { expect(QUALITY_IDS.length).toBe(11); expect(chordSize('sus2')).toBe(3); });
});
